...
void main() {
  runApp(
    const MaterialApp(
      debugShowCheckedModeBanner: false,
      home: HomeScreen(username: "حمزة محمد"),
    ),
  );
}
...
// ==========================================
// صفحة تفاصيل الحساب (تم حذف كلمة المرور منها)
// ==========================================
      ...
      body: Padding(
        ...
        child: Container(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              _buildTile(Icons.person, "الاسم", "sameera hh"),
              const Divider(),
              _buildTile(Icons.email, "البريد", "sameear@gmail.com"),
            ],
          ),
        ),
      ),
