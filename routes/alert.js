 ...
 *     tags:
 *       - Alerts
 *     summary: Get expiring storage item alerts for the authenticated user
 *     responses:
 *       200:
 *         description: Expiring item alerts fetched successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *               $ref: '#/components/schemas/UnauthorizedResponse'
 */
router.get("/expiring", checkAuth, controller.getExpiringItemsAlerts);
